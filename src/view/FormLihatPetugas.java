 ...
 * @author mucha
 */
public class FormLihatPetugas extends javax.swing.JDialog {
    private final DefaultTableModel petugasTableModel;
    private String nipDipilih;
    /**
     * Creates new form FormLihatPetugas
     */
    public FormLihatPetugas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        petugasTableModel = (DefaultTableModel) petugasTable.getModel();
    }
    ...
    public void tampilkanData(Object[][] list){
        ...
        if((list != null) && (list.length > 0)){
            for(int i=0; i<list.length; i++){
                petugasTableModel.addRow(list[i]);
            }
        }
    }
    
    public String getNipDipilih(){
        return nipDipilih;
    }
    /**
    ...
    private void initComponents() {
        ...
        petugasTable = new javax.swing.JTable();
        ...
        petugasTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(petugasTable);
        if (petugasTable.getColumnModel().getColumnCount() > 0) {
            petugasTable.getColumnModel().getColumn(0).setMinWidth(80);
            petugasTable.getColumnModel().getColumn(0).setPreferredWidth(80);
            petugasTable.getColumnModel().getColumn(0).setMaxWidth(150);
        }
    ...
    private void pilihButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihButtonActionPerformed
        ...
        if(petugasTable.getSelectedRowCount() > 0){
            nipDipilih = petugasTable.getValueAt(
                    petugasTable.getSelectedRow(), 0
            ).toString();
            
            dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Belum ad yang dipilih");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLihatPetugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormLihatPetugas dialog = new FormLihatPetugas(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable petugasTable;
